...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://135248895905422"
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://135248895905422" --背景图    
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://73123896118682"--按钮
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://126200447556269
" or "rbxassetid://123340408639352" --   ص ͼ
end)
