...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/wumingjiaoben/qingfeng/refs/heads/main/Protected_1461575662522617.lua"))()
local window = library:new("qw脚本")
...
credits:Toggle("脚本框架变小一点", "", false, function(state)
    ...
    local creds = window:Tab("其它作者", "16060333448")
    local about = creds:section("其它作者", true)
...
local creds = window:Tab("Doors", "16060333448")
    local Doors = creds:section("功能", true)

Doors:Button("每15秒一只screech",function()
...
Doors:Button("每15秒一只halt",function()
        local Data = require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game)
...
Doors:Button("每15秒一只glitch",function()
        local Data = require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game)
...
Doors:Button("每15秒一次心跳小游戏",function()
        local Data = require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game)
...
Doors:Toggle("刷新时通知", "TZ", false, function(TZ)
...
Doors:Toggle("自动躲避Rush/Ambush", "ADB", false, function(ADB)
...
Doors:Toggle("无 Screech", "NCH", false, function(NCH)
...
Doors:Button("可以清除东西的枪", function()
...
Doors:Button("没有惊吓",function()
        pcall(function()
            game:GetService("ReplicatedStorage").Bricks.Jumpscare:Destroy()
        end)
          end)
          
Doors:Button("完整的断路器盒小游戏",function()
        game:GetService("ReplicatedStorage").Bricks.EBF:FireServer()
          end)
Doors:Button("跳过门50",function()
...
Doors:Button("BlackKingq", function()
      loadstring(game:HttpGet(('https://pastebin.com/raw/R8QMbhzv')))()
end)
      
Doors:Button("MS DOORS", function()
...
credits:Button("最强战场",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Nicuse/RobloxScripts/main/SaitamaBattlegrounds.lua"))()
end)

credits:Button("最强战场2",function()
...
credits:Button("举重模拟器1",function()
...
local about = creds:section("跑步机", true)
...
local about = creds:section("『石头』",true)
...
local about = creds:section("『重生』",true)
...
local about = creds:section("『改』",true)

about:Button("力量传奇改力量",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/jynzl/main/main/Musclas%20Legenos.lua'))()
end)

local about = creds:section("卧推",true)
...
local about = creds:section("丢石头",true)
...
local creds = window:Tab("自然灾害模拟器", "16060333448")
    local about = creds:section("功能", true)
...
local creds = window:Tab("俄核俄州", "16060333448")
    local about = creds:section("功能", true)
...
local creds = window:Tab("铲雪模拟器", "16060333448")
    local about = creds:section("功能", true)
...
local creds = window:Tab("门", "16060333448")
    local about = creds:section("功能", true)
...
local creds = window:Tab("鲨口逃生", "16060333448")
    local about = creds:section("功能", true)
